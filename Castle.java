...
class Castle extends Building{
  ...
  public Castle(String team, int[] coords, String imageFileName){
    super("Castle", 3000, 50, 50, team, coords, imageFileName);
  ...
  public Combatant recruit(Terrain[][] boardState, String troop){
    ...
    //If you want to recruit footmen and you have enough gold
      ...
      return new Footman(super.getTeam(), coordinates, "Footman.png"); //Spawns troop
    }
    //If you want to recruit archer and you have enough gold
      ...
      return new Archer(super.getTeam(), coordinates, "Archer.png"); //Spawns troop
    }
    //If you want to recruit knight, have enough gold and castle is at least lvl 2
      ...
      return new Knight(super.getTeam(), coordinates, "Knight.png"); //Spawns troop
    }
    //If you want to recruit crossbowmen, have enough gold and castle is at least lvl 2
      ...
      return new CrossbowMen(super.getTeam(), coordinates, "Crossbowman.png"); //Spawns troop
    }
    //If you want to recruit calvary, have enough gold and castle is lvl 3 (max)
    else if (troop.equals("Cavalry") && gold >= Calvary.getCalvaryPrice() && level == 3){
      gold -= Calvary.getCalvaryPrice(); //Reduces gold count
      return new Cavalry(super.getTeam(), coordinates, "Cavalry.png"); //Spawns troop
    }
